...
vim.opt.colorcolumn = "80,120" -- show a column at 100 position chars
...
vim.keymap.set("n", "<leader>spv", "<cmd>Sex<CR>", { desc = "Open netrw horizontal split" })
vim.keymap.set("n", "<leader>hpv", "<cmd>Vex<CR>", { desc = "Open netrw vertical split" })
